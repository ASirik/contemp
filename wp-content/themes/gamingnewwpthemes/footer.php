...
<?php  } ?>
    ...
    <div id="footer">
        ...
        <?php /*
            ...
            You can buy this theme without footer links online at http://newwpthemes.com/buy/?theme=gaming
        */ ?>

        <div id="credits">Powered by <a href="http://wordpress.org/"><strong>WordPress</strong></a> | Локализация <a href="http://morestyle.ru/" title="шаблоны wordpress" target="_blank"><img alt="темы wordpress" src="http://favicon.yandex.net/favicon/morestyle.ru"></a></div><!-- #credits -->
