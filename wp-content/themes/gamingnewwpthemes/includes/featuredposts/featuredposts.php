    ...
    class Themater_FeaturedPosts
    {
        ...
        var $defaults = array(
            ...
            'custom_default_slides' => array(
                '1' => array('link' => '#', 'title' => 'Это заголовок демо слайда 1', 'content' => 'Вы можете полностью настроить показ слайдов на странице настроек темы. Вы также можете легко отменить показ слайдера на определенной части вашего сайта, как: категории, теги, архивы и т.д.'),
                '2' => array('link' => '#', 'title' => 'Это заголовок демо слайда 2', 'content' => 'Вы можете полностью настроить показ слайдов на странице настроек темы. Вы также можете легко отменить показ слайдера на определенной части вашего сайта, как: категории, теги, архивы и т.д.'),
                '3' => array('link' => '#', 'title' => 'Это заголовок демо слайда 3', 'content' => 'Вы можете полностью настроить показ слайдов на странице настроек темы. Вы также можете легко отменить показ слайдера на определенной части вашего сайта, как: категории, теги, архивы и т.д.'),
                '4' => array('link' => '#', 'title' => 'Это заголовок демо слайда 4', 'content' => 'Вы можете полностью настроить показ слайдов на странице настроек темы. Вы также можете легко отменить показ слайдера на определенной части вашего сайта, как: категории, теги, архивы и т.д.'),
                '5' => array('link' => '#', 'title' => 'Это заголовок демо слайда 5', 'content' => 'Вы можете полностью настроить показ слайдов на странице настроек темы. Вы также можете легко отменить показ слайдера на определенной части вашего сайта, как: категории, теги, архивы и т.д.')
            )
        );
